...
#------------------------
#For Bot
$tanitatikaram = parse_ini_file("config-a960d8e8088a08d22b6167383131e78c663d3f70.ini", true);
...
window.location.href = "85a3ed58bfe7790e21da3294a685e992.php?<?php echo $spo;?>=<?php echo $spo;?>-<?php echo $rand;?>";
}
        }
    }
};
